...
![Political Violence and News Analysis Nigeria](/images/nigeria_images.jpg)
Analyzed political violence and news incidents in Nigeria, employing a range of statistical techniques and visualizations to support strategic decision-making. By delving into time-related data and geographic patterns, I unearthed valuable insights into the dynamics of political violence and its correlation with news incidents. Through in-depth analysis, I identified common events, and high-risk factors, and conducted monthly trends analysis of news data. Utilizing techniques such as word cloud visualization, I effectively communicated key findings, shedding light on prevailing issues and informing proactive measures for mitigating risks and promoting stability in Nigeria.

### [Bank Loan Data Analysis]( https://github.com/ParjitaMunshi/Bank-Loan-Data-Analysis)
![Bank Loan Data Analysis](/images/analysis.png)
This project uses Power BI to analyze bank loan data thoroughly to produce insights that can be put to use in the banking industry. Including total cash, interest received, and important loan performance indicators, the project successfully distinguished between good and poor loans by utilizing a combination of exploratory data mining approaches, statistical analysis, and predictive modeling. The insights gained from the initiative, which covered everything from borrower behavior patterns to factors influencing loan performance, resulted in strategic suggestions aimed at streamlining the loan approval process, reducing risks, and customizing financial solutions. This project demonstrates the capacity to extract actionable insights from complex loan data to achieve organizational performance within the banking domain. It also serves as a testimonial to skill in data analysis, visualization, and strategic decision-making.
